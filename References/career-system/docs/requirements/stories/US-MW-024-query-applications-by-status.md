...
As Paul, I want to query applications by status so that I can quickly see applied, rejected, closed, and not pursued roles.
...
```bash
grep -R "US-MW-024" docs/requirements || true
```
