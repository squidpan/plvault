...
As Paul, I want fit analysis content kept separate from resume professional summaries so that ATS resumes remain clean and employer-ready.
...
```bash
grep -R "US-CS-046" docs/requirements || true
```
