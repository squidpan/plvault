...
As Paul, I want approved resume experience facts preserved so that tailoring does not remove or distort important career evidence.
...
```bash
grep -R "US-CS-047" docs/requirements || true
```
