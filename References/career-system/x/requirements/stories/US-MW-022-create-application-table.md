...
As a Motorweb developer, I want an application table so that Career System applications can be persisted in PostgreSQL.
...
```bash
grep -R "US-MW-022" docs/requirements || true
```
