...
pursuit_recommendation: network_or_research_first
combined_strategy_score: 75
recommended_resume_family: application-support / production-support
---

# Resume Tailoring — VNS Health — Enterprise Applications Analyst (Workday & Enterprise Systems)
...
Position Paul as a senior BA/application support professional with strong production support, release validation, incident coordination, runbook, Linux, Oracle, and financial enterprise systems experience.
...
- Enterprise application workflow support / Workday transferability
...
- Add transferability language for Workday: enterprise application support, workflow analysis, UAT, and rapid platform ramp-up.
...
- Do not claim direct Workday administration if experience is transferable rather than hands-on.

## Cover Letter Angle

Open with production/application support fit: FRBNY financial systems, incident coordination, release readiness, and runbook-driven operational stability for Enterprise Applications Analyst (Workday & Enterprise Systems) at VNS Health.
...
Use this tailoring guidance to update the resume for VNS Health — Enterprise Applications Analyst (Workday & Enterprise Systems).
