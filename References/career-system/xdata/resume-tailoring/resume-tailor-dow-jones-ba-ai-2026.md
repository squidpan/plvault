...
status: draft
run_id: run-2026-06-08-resume-tailoring-v1
source: career-system
company: Dow Jones
role: AI Enablement Business Analyst, Senior
role_code: ba-ai
pursuit_recommendation: pursue_first
combined_strategy_score: 97
recommended_resume_family: business analyst / business systems analyst
---

# Resume Tailoring — Dow Jones — AI Enablement Business Analyst, Senior
...
Position Paul as a senior BA/BSA with enterprise modernization, requirements, UAT, data validation, Jira/acceptance criteria, stakeholder management, and FRBNY financial systems experience.
...
Open with BA/BSA fit: requirements, UAT, data validation, enterprise modernization, and stakeholder communication relevant to AI Enablement Business Analyst, Senior at Dow Jones.
...
Use this tailoring guidance to update the resume for Dow Jones — AI Enablement Business Analyst, Senior.
