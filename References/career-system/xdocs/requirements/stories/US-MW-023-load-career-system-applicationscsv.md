...
As a Motorweb developer, I want to load applications.csv into PostgreSQL so that Career System tracker data becomes queryable.
...
```bash
grep -R "US-MW-023" docs/requirements || true
```
