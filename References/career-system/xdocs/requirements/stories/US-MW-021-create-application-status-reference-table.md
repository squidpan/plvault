...
As a Motorweb developer, I want an application status reference table so that statuses are canonical and queryable.
...
```bash
grep -R "US-MW-021" docs/requirements || true
```
