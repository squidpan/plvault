...
As a Motorweb developer, I want SQL validation against the source CSV so that PostgreSQL is proven to match Career System data.
...
```bash
grep -R "US-MW-026" docs/requirements || true
```
