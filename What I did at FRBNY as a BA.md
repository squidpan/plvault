...
Working closely with Product Owner (PO), Scrum master, architecture, development and operations support team in an Agile delivery environment, I was tasked with managing release requirements as JIRA stories for the development team, testing, deploying code to the QA environment:
