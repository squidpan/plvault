...
source: "https://system76.com/support/articles/wireless?srsltid=AfmBOop-xKWLyyZdrFzGlAgjK8jyhsbFpWu6aXY0ziBCB072_K6AYgUo"
author:
published: 2026-07-09
created: 2026-07-13
description: "If your computer can’t connect to wireless networks or the connection is unstable, use this guide to diagnose and resolve the issue."
tags:
  - "clippings"
url: "https://system76.com/support/articles/wireless?srsltid=AfmBOop-xKWLyyZdrFzGlAgjK8jyhsbFpWu6aXY0ziBCB072_K6AYgUo"
---
...
> options iwlwifi 11n\_disable=8
...
> options iwlwifi bt\_coex\_active=0
...
The name of the Linux driver for Intel Wi-Fi cards is called iwlwifi and is included in the kernel by default. All information about the driver can be found [on the Kernel.org wiki](https://wireless.wiki.kernel.org/en/users/drivers/iwlwifi).
...
- [Initial Troubleshooting](https://system76.com/support/articles/wireless#initial-troubleshooting)
- [Router and Access Point Recommendations](https://system76.com/support/articles/wireless#router-and-access-point-recommendations)
- [Device-Level Checks and Commands](https://system76.com/support/articles/wireless#device-level-checks-and-commands)
- [Driver and Firmware Checks](https://system76.com/support/articles/wireless#driver-and-firmware-checks)
- [NetworkManager and Configuration Tips](https://system76.com/support/articles/wireless#networkmanager-and-configuration-tips)
- [Bluetooth and Airplane Mode Interactions](https://system76.com/support/articles/wireless#bluetooth-and-airplane-mode-interactions)
- [Advanced Troubleshooting](https://system76.com/support/articles/wireless#advanced-troubleshooting)
- [IPv6](https://system76.com/support/articles/wireless#ipv6)
- [Antenna Aggregation](https://system76.com/support/articles/wireless#antenna-aggregation)
- [N Mode](https://system76.com/support/articles/wireless#n-mode)
- [Bluetooth Coexistence](https://system76.com/support/articles/wireless#bluetooth-coexistence)
- [Power Management](https://system76.com/support/articles/wireless#power-management)
- [Useful Programs](https://system76.com/support/articles/wireless#useful-programs)
- [Useful Commands](https://system76.com/support/articles/wireless#useful-commands)
- [Additional Info](https://system76.com/support/articles/wireless#additional-info)
- [Windows Dual Boot](https://system76.com/support/articles/wireless#windows-dual-boot)
- [Contact System76 Support](https://system76.com/support/articles/wireless#contact-system76-support)